...
**Цель задания:** Изучить работу системы принудительного контроля доступа (MAC) AppArmor, проанализировать поведение системы через системные логи и полностью удалить пакеты по окончании эксперимента.
...
2. **Активация профилей:**
   Выводим текущий статус подсистемы безопасности командой `/sbin/aa-status`. На Скриншоте  фиксируется большой список загруженных в ядро Linux профилей ограничений. 
    
    > **📸 Скриншот статуса подсистемы безопасности:**

![Скриншот статуса](./img/8.jpg)
...
4. **Анализ результатов через системный лог:**
